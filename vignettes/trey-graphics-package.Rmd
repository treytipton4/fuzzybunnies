---
title: "trey-graphics-package, plotly"
author: "Trey Tipton"
...
Overall, plotly proves itself to be a useful graphics package as it goes above and beyond most other packages. There are a lot of other useful things plotly can do, especially for maps. Think about how helpful interactivity would be on a geographical map, as you can hover over specific countries or cities to gain insgihtful information. I am glad that I learned plotly because interactive visualizations are often times more useful, and even if they are not, it usually does not hurt to have them be interactive.
